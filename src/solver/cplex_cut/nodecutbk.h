...
class NodeCutBkCallback : public IloCplex::LazyConstraintCallbackI
{
public:
  typedef GR Graph;
  ...
  NodeCutBkCallback(const NodeCutBkCallback& other)
...
protected:
  ...
  {
    return (new (getEnv()) NodeCutBkCallback(*this));
  }
...
inline void NodeCutBkCallback<GR, NWGHT, NLBL, EWGHT>::main()
{
  //lemon::Timer t;
